...
//             try self.audioSession.setActive(false, options: .notifyOthersOnDeactivation)
    ...
    private func initializeAudioSession(){
        do {
            ...
            try self.audioSession.setCategory(AVAudioSession.Category.playAndRecord, options: [.allowBluetooth,.allowBluetoothA2DP,.defaultToSpeaker])
